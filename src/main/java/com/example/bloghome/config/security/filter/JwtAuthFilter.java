...
import com.example.bloghome.config.security.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        // HEADER에서 JWT 토큰 값만 가져와서 Manager에 넘길 토큰 생성
    ...
    @Override
    protected void unsuccessfulAuthentication( //JWT 인증을 선공하면 인증보관함에 리퀘스트에다가 저장을 해준다
            HttpServletRequest request,
            HttpServletResponse response,
